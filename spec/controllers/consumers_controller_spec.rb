...
describe ConsumersController do
  ...
  # ConsumersController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested consumer as @consumer" do
      consumer = Consumer.create! valid_attributes
      get :show, {:id => consumer.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested consumer as @consumer" do
      consumer = Consumer.create! valid_attributes
      get :edit, {:id => consumer.to_param}, valid_session
      assigns(:consumer).should eq(consumer)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Consumer" do
        expect {
          post :create, {:consumer => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved consumer as @consumer" do
        ...
        post :create, {:consumer => {}}, valid_session
        assigns(:consumer).should be_a_new(Consumer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested consumer" do
        ...
        put :update, {:id => consumer.to_param, :consumer => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested consumer as @consumer" do
        consumer = Consumer.create! valid_attributes
        put :update, {:id => consumer.to_param, :consumer => valid_attributes}, valid_session
        assigns(:consumer).should eq(consumer)
      end
    ...
    describe "with invalid params" do
      it "assigns the consumer as @consumer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Consumer.any_instance.stub(:save).and_return(false)
        put :update, {:id => consumer.to_param, :consumer => {}}, valid_session
        assigns(:consumer).should eq(consumer)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested consumer" do
      consumer = Consumer.create! valid_attributes
      expect {
        delete :destroy, {:id => consumer.to_param}, valid_session
      }.to change(Consumer, :count).by(-1)
    end
